...
type pubsuberClient struct {
	cc grpc.ClientConnInterface
}

func NewBroadcasterClient(cc grpc.ClientConnInterface) BroadcasterClient {
	return &pubsuberClient{cc}
}

func (c *pubsuberClient) Broadcast(ctx context.Context, in *BroadcastRequest, opts ...grpc.CallOption) (*BroadcastResponse, error) {
	out := new(BroadcastResponse)
	err := c.cc.Invoke(ctx, "/pubsub.Broadcaster/Broadcast", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Broadcaster_Broadcast_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pubsub.Broadcaster/Broadcast",
	}
...
var Broadcaster_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pubsub.Broadcaster",
